...
describe('constructor', () => {
  ...
  test('sets body and normalizedHost according to id property of given object', () => {
    ...
    const object = new ActivityStreams(body, AnyHost);

    expect(object).toHaveProperty('normalizedHost', 'remote.xn--kgbechtv');
    return expect(object.body).resolves.toBe(body);
  });
  ...
  */
  test('sets body and normalizedHost according to given normalizedHost argument if host is not available from given body', () => {
    const body = {};
    const object = new ActivityStreams(body, 'remote.xn--kgbechtv');
...
describe('getItems', () => {
  test('loads and returns ordered items of ordered collection', () => {
    ...
    return testLoading({
      ...
      .toHaveProperty('body', 'https://ReMoTe.إختبار/item'));
  });
  ...
  test('normalizes and returns itself if it is an array', async () => {
    const object = new ActivityStreams(['https://ReMoTe.إختبار/item'], AnyHost);
  ...
  test('loads and returns itself if it is not a collection nor an array', () => {
    ...
    return testLoading({
      '@context': 'https://www.w3.org/ns/activitystreams'
    }, () => object.getItems(repository).then(([{ body }]) =>
...
describe('getInbox', () => test('loads and returns inbox', () => {
  ...
  return testLoading({
    ...
    .resolves
    .toHaveProperty('body', 'https://ReMoTe.إختبار/inbox'));
}));
...
describe('getObject', () => test('loads and returns object', () => {
  ...
  return testLoading({
    ...
    .resolves
    .toHaveProperty('body', 'https://ReMoTe.إختبار/object'));
}));
...
describe('getPublicKey', () => test('loads and returns public key', () => {
  ...
  return testLoading({
    ...
    .resolves
    .toHaveProperty('body', 'https://ReMoTe.إختبار/publickey'));
}));
...
describe('act', () => {
  test('performs create activity', async () => {
    const activity = new ActivityStreams('https://ReMoTe.إختبار/', AnyHost);
  ...
  describe('if actor is specified', () => {
    ...
    test('rejects if actor mismatches', async () => {
      const activity = new ActivityStreams('https://ReMoTe.إختبار/', AnyHost);
      const [expectedActor, object] = await Promise.all([
