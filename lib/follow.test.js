...
async function fabricateRemoteActor(username) {
  const actor = new Person({
    account: new RemoteAccount({
      inbox: { uri: 'http://AcToR.إختبار/inbox' },
      publicKey: {
        uri: 'http://AcToR.إختبار/#publickey',
        publicKeyPem: 'public key PEM'
      },
      uri: 'http://AcToR.إختبار/'
    }),
    username,
...
describe('selectPersonByActor', () =>
  test('loads and returns actor person', async () => {
    ...
    expect(result).toHaveProperty('username', '行動者');
...
describe('selectPersonByObject', () =>
  test('loads and returns object person', async () => {
    ...
    expect(result).toHaveProperty('username', '被行動者');
    expect(result).toHaveProperty('host', null);
  }));
...
describe('selectRemoteAccountByActor', () =>
  test('loads and returns actor remote account', async () => {
    ...
    expect(result).toHaveProperty(
      ['publicKey', 'uri'], 'http://AcToR.إختبار/#publickey');

    expect(result).toHaveProperty('uri', 'http://AcToR.إختبار/');
  }));
...
describe('create', () => {
  ...
  */
  test('creates accept activity', async () => {
    ...
    const post = nock('http://AcToR.إختبار').post('/inbox').reply(200);
...
describe('fromActivityStreams', () => {
  test('creates follow from ActivityStreams representation', async () => {
    ...
    nock('http://AcToR.إختبار').post('/inbox').reply(200);
