...
export default class {
  ...
  static async fromActivityStreams(repository, host, { id, inbox, publicKey, preferredUsername: username }) {
  ...
  static async resolveByKeyUri(repository, uri) {
    ...
    const activityStreams = await getActivityStreams(uri);

    if (activityStreams.publicKey.id != uri) {
      throw new Error;
    }
